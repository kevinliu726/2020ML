...
source_dataloader = DataLoader(source_dataset, batch_size=16, shuffle=True)
target_dataloader = DataLoader(target_dataset, batch_size=16, shuffle=True)
...
#ckpt = torch.load('./extractor_model.bin')
#feature_extractor.load_state_dict(ckpt)
#ckpt = torch.load('./predictor_model.bin')
#label_predictor.load_state_dict(ckpt)
...
for epoch in range(2000):
    ...
    train_D_loss, train_F_loss, train_acc = train_epoch(source_dataloader, target_dataloader, lamb=Lambda)
