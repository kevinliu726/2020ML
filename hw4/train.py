...
def training(batch_size, n_epoch, lr, model_dir, train, valid, model, device):
    ...
    for epoch in range(n_epoch):
        ...
        myTrainLoss.append(total_loss / t_batch)
        myTrainAcc.append(total_acc / t_batch)
        ...
        with torch.no_grad():
            ...
            myValLoss.append(total_loss / v_batch)
            myValAcc.append(total_acc / v_batch)
